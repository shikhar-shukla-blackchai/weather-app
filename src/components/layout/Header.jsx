...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-white/10 dark:border-white/5 bg-white/50 dark:bg-gray-950/50 backdrop-blur-2xl animate-slide-down">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                onClick={toggleUnit}
                className={cn(
                  "relative h-8 w-16 rounded-full px-0",
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                size="icon"
                onClick={toggleTheme}
                className="h-8 w-8 rounded-full bg-white/60 dark:bg-white/5 border border-white/20 dark:border-white/10 hover:bg-white/80 dark:hover:bg-white/10 transition-all duration-300"
